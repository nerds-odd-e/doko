...
func TestNormalNumber60(t *testing.T) {
	assert.Equal(t, "FizzBuzz", findFizzBuzz(60))
}
...
func TestNormalNumber30(t *testing.T) {
	assert.Equal(t, "FizzBuzz", findFizzBuzz(30))
}

func TestFizzBuzz(t *testing.T) {
	assert.Equal(t, "Buzz", findFizzBuzz(10))
}
